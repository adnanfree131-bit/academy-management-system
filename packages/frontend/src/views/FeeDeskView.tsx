...
export const FeeDeskView: React.FC<FeeDeskViewProps> = ({ initialStudentId }) => {
  ...
  const [showCashierOverviewCards, setShowCashierOverviewCards] = useState<boolean>(false);
  const [showCashierClassFilter, setShowCashierClassFilter] = useState<boolean>(false);
  const [showDefaulterOverviewCards, setShowDefaulterOverviewCards] = useState<boolean>(false);
  const [showDefaulterFilters, setShowDefaulterFilters] = useState<boolean>(false);
  ...
  return (
    <div className="space-y-2.5 sm:space-y-3">
      ...
      <div className="flex items-center justify-between gap-2.5">
        ...
        {/* Global Module Actions Menu available across ALL tabs (Cashier, Defaulters, Reports) */}
        <div ref={feeModuleContainerRef} className="relative shrink-0">
          <button
            type="button"
          ...
          {/* Dropdown Menu containing all actions, views, slider, and tools */}
          {showFeeModuleMenu && (
            <div className="absolute right-0 top-full mt-1.5 w-60 bg-white rounded-xl border border-slate-200 shadow-xl py-1 z-50 divide-y divide-slate-100 text-left animate-in fade-in zoom-in-95 duration-100">
              {/* Primary Action */}
              <div className="p-1.5">
                <button
                  type="button"
              ...
              <div className="py-1">
                ...
                <button
                  ...
                  className={`w-full px-3 py-1.5 text-xs flex items-center justify-between transition-colors cursor-pointer ${
                    (activeTab as string) === 'cashier' ? 'text-amber-800 font-bold bg-amber-50/50' : 'text-slate-700 hover:bg-slate-50'
                  }`}
                >
                ...
                <button
                  ...
                  className={`w-full px-3 py-1.5 text-xs flex items-center justify-between transition-colors cursor-pointer ${
                    (activeTab as string) === 'defaulters' ? 'text-amber-800 font-bold bg-amber-50/50' : 'text-slate-700 hover:bg-slate-50'
                  }`}
                >
                  <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`w-full px-3 py-1.5 text-xs flex items-center justify-between transition-colors cursor-pointer ${
                    (activeTab as string) === 'reports' ? 'text-amber-800 font-bold bg-amber-50/50' : 'text-slate-700 hover:bg-slate-50'
                  }`}
                >
                  <div className="flex items-center gap-2">
              ...
              <div className="py-1">
                ...
                <button
                  ...
                  onClick={() => {
                    if (activeTab === 'defaulters') {
                      setShowDefaulterOverviewCards(prev => !prev);
                    } else {
                      setShowCashierOverviewCards(prev => !prev);
                    }
                  }}
                ...
                >
                  ...
                  <div className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out ${
                    (activeTab === 'defaulters' ? showDefaulterOverviewCards : showCashierOverviewCards) ? 'bg-amber-600' : 'bg-slate-300'
                  }`}>
                    <span className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow-xs ring-0 transition duration-200 ease-in-out ${
                      (activeTab === 'defaulters' ? showDefaulterOverviewCards : showCashierOverviewCards) ? 'translate-x-4' : 'translate-x-0'
                    }`} />
                  </div>
                </button>
              </div>
              ...
              <div className="py-1">
                ...
                <button
                  ...
                  onClick={() => {
                    setShowFeeModuleMenu(false);
                    setShowConcessionReportModal(true);
                  }}
                  className="w-full px-3 py-1.5 text-xs text-slate-700 hover:bg-slate-50 flex items-center gap-2 transition-colors cursor-pointer"
                >
      ...
      {activeTab === 'cashier' && (
        <div className="space-y-2.5 sm:space-y-3">
          {/* 4 Financial Overview Cards (Elevated Institutional Semantic Design) */}
          {showCashierOverviewCards && (
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 animate-in fade-in duration-150">
              <div className="bg-[#081A2F] border border-[#173252] hover:border-sky-500/50 hover:bg-[#0b213b] rounded-xl px-3 py-2 flex items-center justify-between shadow-[0_2px_8px_rgba(8,26,47,0.18)] transition-all">
                <div>
              ...
              <div className="bg-[#081A2F] border border-[#173252] hover:border-emerald-500/50 hover:bg-[#0b213b] rounded-xl px-3 py-2 flex items-center justify-between shadow-[0_2px_8px_rgba(8,26,47,0.18)] transition-all">
                <div>
              ...
              <div className="bg-[#081A2F] border border-[#173252] hover:border-amber-500/50 hover:bg-[#0b213b] rounded-xl px-3 py-2 flex items-center justify-between shadow-[0_2px_8px_rgba(8,26,47,0.18)] transition-all">
                <div>
              ...
              <div className="bg-[#081A2F] border border-[#173252] hover:border-rose-500/50 hover:bg-[#0b213b] rounded-xl px-3 py-2 flex items-center justify-between shadow-[0_2px_8px_rgba(8,26,47,0.18)] transition-all">
                <div>
          ...
          {/* Controls Toolbar: Standalone Search Bar + Filter + Parallel Options Button */}
          <div className="bg-white border border-slate-200 rounded-xl p-3 shadow-2xs">
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => setShowCashierClassFilter(prev => !prev)}
                className={`w-9 h-9 sm:w-8 sm:h-8 rounded-lg border flex items-center justify-center transition-colors cursor-pointer shrink-0 relative ${
                  showCashierClassFilter || cashierClassFilter !== 'all'
            ...
            {/* Class Filter Row */}
            {showCashierClassFilter && (
              <div className="mt-3 pt-3 border-t border-slate-100 flex items-center gap-2 animate-in fade-in duration-150">
      ...
      {activeTab === 'defaulters' && (
        <div className="space-y-3">
          {/* Summary Overview Cards (Sidebar Dark Navy Design) */}
          {showDefaulterOverviewCards && (
            <div className="flex items-center gap-2 flex-wrap animate-in fade-in duration-150">
              ...
              <div className="bg-[#081A2F] border border-[#173252] rounded-lg px-2.5 py-1.5 flex items-center gap-2 shadow-2xs">
                <span className="text-[10px] uppercase font-mono font-bold text-slate-400">Total Dues:</span>
                <span className="font-mono font-bold text-white text-xs">PKR {totalDefaultersAmount.toLocaleString()}</span>
              </div>
            </div>
          )}
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-3 shadow-2xs">
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={() => setShowDefaulterFilters(prev => !prev)}
                className={`w-9 h-9 sm:w-8 sm:h-8 rounded-lg border flex items-center justify-center transition-colors cursor-pointer shrink-0 relative ${
                  showDefaulterFilters || activeDefaulterFilterCount > 0 || duesView !== 'all'
                    ? 'bg-amber-50 text-amber-900 border-amber-300'
                    : 'bg-white text-slate-700 border-slate-200 hover:bg-slate-50'
                }`}
