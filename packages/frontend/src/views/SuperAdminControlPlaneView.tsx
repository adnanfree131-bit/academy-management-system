                      ...
                      <td className="p-3 text-right">
                        <div className="flex items-center justify-end gap-1.5 flex-wrap">
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 bg-white hover:bg-amber-50 text-amber-800 font-semibold text-xs rounded border border-amber-300 shadow-xs transition-colors flex items-center gap-1 cursor-pointer"
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-6 shadow-xs max-w-3xl space-y-6">
          ...
          <form onSubmit={handleSavePlatformConfig} className="space-y-5 text-xs">
            ...
            <button
              ...
              className="px-4 py-2 bg-amber-600 hover:bg-amber-700 active:bg-amber-800 disabled:bg-slate-400 text-white font-bold text-xs rounded shadow-xs flex items-center gap-1.5 transition-colors cursor-pointer"
            >
          ...
          <div className="p-3.5 border-b border-slate-200 bg-slate-50 flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-amber-600 hover:bg-amber-700 active:bg-amber-800 text-white text-xs font-bold rounded-lg shadow-xs cursor-pointer"
              >
                Save backup now
              </button>
            </div>
            ...
            <div className="p-5 space-y-6 text-xs overflow-y-auto flex-1">
              ...
              <div className="p-3.5 bg-slate-50/80 border border-slate-200 rounded-lg flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <button
                    ...
                    className="h-8 px-2.5 py-1 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-xs rounded-lg shadow-xs flex items-center gap-1.5 transition-colors cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="h-8 px-2.5 py-1 bg-amber-600 hover:bg-amber-700 active:bg-amber-800 text-white font-semibold text-xs rounded-lg shadow-xs flex items-center gap-1.5 transition-colors cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="h-8 px-2.5 py-1 bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 font-semibold text-xs rounded-lg shadow-2xs flex items-center gap-1.5 transition-colors cursor-pointer"
                  >
              ...
              <form onSubmit={handleSaveBillingParams} className="p-4 border border-slate-200 rounded-lg space-y-4">
                <div className="flex items-center justify-between border-b border-slate-200 pb-2">
                  ...
                  <button
                    ...
                    className="h-8 px-2.5 py-1 bg-amber-600 hover:bg-amber-700 active:bg-amber-800 disabled:bg-slate-400 text-white font-semibold text-xs rounded-lg shadow-xs flex items-center gap-1.5 transition-colors cursor-pointer"
                  >
              ...
              <div className="p-3.5 bg-rose-50/50 border border-rose-200 rounded-lg flex items-center justify-between">
                ...
                <button
                  ...
                  className="h-8 px-2.5 py-1 bg-rose-700 hover:bg-rose-800 text-white font-semibold text-xs rounded-lg shadow-xs flex items-center gap-1.5 transition-colors cursor-pointer"
                >
                  <Trash2 className="w-3.5 h-3.5" />
            ...
            <form onSubmit={handleSubmitAdvancePayment} className="p-5 space-y-4 text-xs overflow-y-auto flex-1">
                ...
                <div className="grid grid-cols-4 gap-1.5">
                  {[1, 2, 3, 6].map(m => (
                    <button
                      ...
                      className={`py-1.5 px-2 rounded-lg border font-semibold text-xs transition-colors cursor-pointer ${
              ...
              <div className="flex items-center justify-end gap-2 pt-2 shrink-0">
                <button
                  type="button"
                  onClick={() => setAdvanceModalOpen(false)}
                  className="h-8.5 px-3.5 py-1.5 bg-white hover:bg-slate-50 border border-slate-300 text-slate-700 font-semibold text-xs rounded-lg transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="h-8.5 px-3.5 py-1.5 bg-amber-600 hover:bg-amber-700 active:bg-amber-800 disabled:bg-slate-400 text-white font-semibold text-xs rounded-lg shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
                >
                  <Check className="w-3.5 h-3.5" />
            ...
            <form onSubmit={handleConfirmHardDelete} className="p-5 space-y-4 text-xs overflow-y-auto flex-1">
              ...
              <div className="flex items-center justify-end gap-2 pt-2 shrink-0">
                ...
                <button
                  ...
                  className="h-8.5 px-3.5 py-1.5 bg-rose-700 hover:bg-rose-800 disabled:bg-rose-300 text-white font-semibold text-xs rounded-lg shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
                >
                  <Trash2 className="w-3.5 h-3.5" />
            ...
            <form onSubmit={handleSubdomainRename} className="p-5 space-y-4 text-xs overflow-y-auto flex-1">
              ...
              <div className="flex items-center justify-end gap-2 pt-2 shrink-0">
                ...
                <button
                  ...
                  className="h-8.5 px-3.5 py-1.5 bg-amber-600 hover:bg-amber-700 active:bg-amber-800 disabled:bg-slate-400 text-white font-semibold text-xs rounded-lg shadow-xs transition-colors cursor-pointer"
                >
            ...
            <div className="p-5 space-y-4 text-xs overflow-y-auto flex-1">
              ...
              <div className="flex items-center justify-end gap-2 pt-2 shrink-0">
                ...
                <button
                  ...
                  className="h-8.5 px-3.5 py-1.5 bg-rose-700 hover:bg-rose-800 disabled:bg-rose-400 text-white font-semibold text-xs rounded-lg shadow-xs transition-colors cursor-pointer"
                >
