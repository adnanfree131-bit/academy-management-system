      ...
      <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs">
        ...
        <div className="mt-5 pt-4 border-t border-slate-100 grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
          ...
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80">
            ...
            <span className="text-2xl font-black font-mono text-slate-900 mt-0.5 block">{batches.length} Batches</span>
          ...
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80">
            ...
            <span className="text-2xl font-black font-mono text-slate-900 mt-0.5 block">{pendingAttendance.length} Batch</span>
          ...
          <div className="p-3 bg-slate-50 rounded-xl border border-slate-200/80">
            ...
            <span className="text-2xl font-black font-mono text-slate-900 mt-0.5 block">{pendingGrading.length} Exams</span>
